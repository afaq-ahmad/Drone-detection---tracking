...
if __name__ == '__main__':
    yolo3 = YOLOv3("drone_detection/mavicpro2_drone_dataset/yolov3.cfg","drone_detection/mavicpro2_drone_dataset//backup/yolov3_best.weights",
    "drone_detection/mavicpro2_drone_dataset/obj.names", is_plot=True)
    print("yolo3.size =",yolo3.size)
    import os
    root = "../demo"
    files = [os.path.join(root,file) for file in os.listdir(root)]
    files.sort()
    files=['drone_detection/mavicpro2_drone_dataset/images/34326.png']
